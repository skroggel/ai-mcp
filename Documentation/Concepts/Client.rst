...
The ``StreamableHttpMcpClient`` implements the HTTP MCP boundary. It supports:
...
The client does not decide which tool a model should call. It only performs MCP communication.
That decision belongs to the AI Core tool loop or another host application.
